...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name        = "${var.app_name}-public-subnet-${data.aws_availability_zones.available.names[count.index]}"
    Environment = var.environment
    Type        = "public"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name        = "${var.app_name}-private-subnet-${data.aws_availability_zones.available.names[count.index]}"
    Environment = var.environment
    Type        = "private"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name        = "${var.app_name}-private-rt-${data.aws_availability_zones.available.names[count.index]}"
    Environment = var.environment
  }
}
